...
export interface ApiAboutUsPageAboutUsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    info_section: Schema.Attribute.Component<'blocks.info-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    our_system_section: Schema.Attribute.Component<
      'blocks.our-system-section',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    story_section: Schema.Attribute.Component<'blocks.story-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    related_blogs: Schema.Attribute.Component<
      'blocks.insights-section',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiCareerPageCareerPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    hero_section: Schema.Attribute.Component<'blocks.career-page-hero', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    life_at_rim: Schema.Attribute.Component<'blocks.life-at-rim', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    values_section: Schema.Attribute.Component<'blocks.values-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hero: Schema.Attribute.Component<'blocks.case-study-hero', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    other_projects: Schema.Attribute.Component<
    ...
    publishedAt: Schema.Attribute.DateTime;
    section_1: Schema.Attribute.Component<'blocks.cs-section-1', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    section_2: Schema.Attribute.Component<'blocks.cs-section-2', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    section_3: Schema.Attribute.Component<'blocks.cs-section-3', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    section_4: Schema.Attribute.Component<'blocks.cs-section-3', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    section_5: Schema.Attribute.Component<'blocks.cs-section-4', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    partners: Schema.Attribute.Component<'elements.logo', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiDepartmentDepartment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'department'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    career_section: Schema.Attribute.Component<'blocks.career-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    case_studies_section: Schema.Attribute.Component<
      'blocks.case-studies-section',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    insights_section: Schema.Attribute.Component<
      'blocks.insights-section',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    >;
    other_projects_section: Schema.Attribute.Component<
      'blocks.projects-section',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    terms_of_service_section: Schema.Attribute.Component<
      'blocks.terms-of-service-section',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    who_we_are: Schema.Attribute.Component<'blocks.who-we-are', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiJobEnquiryFormJobEnquiryForm
  extends Struct.CollectionTypeSchema {
  collectionName: 'job_enquiry_forms';
  info: {
    displayName: 'Job Enquiry Form';
    pluralName: 'job-enquiry-forms';
    singularName: 'job-enquiry-form';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    applyFor: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::job-enquiry-form.job-enquiry-form'
    > &
      Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    yearsOfExperience: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
...
export interface ApiJobListingJobListing extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    share: Schema.Attribute.Component<'elements.logo-link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLifeAtRimLifeAtRim extends Struct.SingleTypeSchema {
  collectionName: 'life_at_rims';
  info: {
    displayName: 'Life At Rim';
    pluralName: 'life-at-rims';
    singularName: 'life-at-rim';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    hero: Schema.Attribute.Component<'blocks.service-hero-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    related_industries: Schema.Attribute.Component<
    ...
    related_projects: Schema.Attribute.Component<
      'blocks.projects-section',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    service_details: Schema.Attribute.Component<
...
export interface ApiVideoConferenceVideoConference
  extends Struct.CollectionTypeSchema {
  collectionName: 'video_conferences';
  info: {
    displayName: 'Video Conference';
    pluralName: 'video-conferences';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::video-conference.video-conference'
    > &
      Schema.Attribute.Private;
    origin: Schema.Attribute.String;
    phone: Schema.Attribute.String & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::video-conference.video-conference': ApiVideoConferenceVideoConference;
